                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">ResidentType</h3>
                                </li>
                            </ul>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-lg-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            {{Session::get('status')}}
                                 <form method="POST" action="{{route('residentType.update',$resident->id)}}">
                                                @csrf
                                                @method('PATCH')
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="example"
                                                               data-parsley-minlength="6" placeholder="Add ResidentType" name="resident_type_name" value="{{$resident->resident_type_name}}">
                                                        @error('resident_type_name')
